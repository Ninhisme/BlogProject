                    ...
                    <div class="card-body">
                            ...
                            <form action="{{route('store.portfolio')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="portfilio_name" class="form-control" type="text"  id="example-text-input">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="portfilio_title" class="form-control" type="text"  id="example-text-input">
