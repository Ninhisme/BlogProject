                    ...
                    <div class="breadcrumb__wrap__content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{$portfolio->portfilio_name}}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="services__details__thumb">
                        <img src="{{asset($portfolio->portfilio_image)}}" alt="">
                    </div>
                    <div class="services__details__content">
                        <h2 class="title">{{$portfolio->portfilio_title}}</h2>
                        <p>{!! $portfolio->portfilio_description !!}</p>
